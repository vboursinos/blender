...
TEST(bmesh_core, BMVertCreate)
{
  ...
  BMesh *bm = BM_mesh_create(&bm_mesh_allocsize_default, &bmesh_create_params);
  ...
  BMVert *bv1 = BM_vert_create(bm, {1.0f, 2.0f, 0.0f}, nullptr, BM_CREATE_NOP);
  ...
  BMVert *bv2 = BM_vert_create(bm, nullptr, nullptr, BM_CREATE_NOP);
  ...
  BMVert *bv3 = BM_vert_create(bm, {1.0f, 2.0f, 0.0f}, bv2, BM_CREATE_NOP);
